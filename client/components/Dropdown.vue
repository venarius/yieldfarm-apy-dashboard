<template>
  <div class="dropdown inline-block relative">
    <button aria-label="sorting dropdown" class="font-semibold rounded flex items-center w-full" :class="{ 'focus:outline-none p-0': noOutline, 'p-2': !noOutline }" @click="showDropdown = !showDropdown">
